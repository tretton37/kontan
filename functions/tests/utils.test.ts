import {weekdayKeyToDayStr, getUpcomingWeekdayKeys, getWeek, getDay}
  from "../src/utils";

describe("weekdayKeyToDayStr", () => {
  test("2023-02-17 should return 'Friday, 17 February'", () => {
    expect(weekdayKeyToDayStr("2023-02-17"))
        .toBe("Friday, 17 February");
  });

  test("2023-02-17 should return 'Friday, 17/02'", () => {
    expect(weekdayKeyToDayStr("2023-02-17", false))
        .toBe("Friday, 17/02");
  });
});
...
describe("getUpcomingWeekdayKeys", () => {
  ...
  test("2023-02-20 should return 9 days", () => {
    expect(getUpcomingWeekdayKeys()).toEqual(["2020-02-21", "2020-02-24",
